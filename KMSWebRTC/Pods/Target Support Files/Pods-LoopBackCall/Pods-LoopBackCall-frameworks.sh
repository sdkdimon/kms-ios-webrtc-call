...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "$BUILT_PRODUCTS_DIR/KMSClient/KMSClient.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/CGSizeAspectRatioTool/CGSizeAspectRatioTool.framework"
